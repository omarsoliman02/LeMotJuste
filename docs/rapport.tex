...
pictogrammes illustrant en un coup d'œil les règles (indice de départ, six essais,
...
données des trois services (\texttt{GET /api/players}, le nouvel endpoint
\texttt{GET /api/games} qui liste toutes les parties tous joueurs confondus, et
\texttt{GET /api/scores}) : cartes de synthèse (nombre de joueurs, de parties, de
parties en cours, taux de victoire global) et tableaux détaillés. Aucune
authentification n'a été ajoutée (hors périmètre du projet, cf. §8) : la vue est
accessible à quiconque connaît l'URL du frontend, comme le reste de l'application.
